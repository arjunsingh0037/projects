...
$string['choosereadme'] = 'booster is a modern highly-customisable theme. This theme is intended to be used directly, or as a parent theme when creating new themes utilising Bootstrap 4.';
$string['currentinparentheses'] = '(current)';
$string['configtitle'] = 'booster';
$string['generalsettings'] = 'General settings';
$string['pluginname'] = 'booster';
$string['presetfiles'] = 'Additional theme preset files';
$string['presetfiles_desc'] = 'Preset files can be used to dramatically alter the appearance of the theme. See <a href=https://docs.moodle.org/dev/booster_Presets>booster presets</a> for information on creating and sharing your own preset files, and see the <a href=http://moodle.net/booster>Presets repository</a> for presets that others have shared.';
...
$string['sec1settings'] = 'Section1 Settings';
$string['course1'] = 'First Course Name';
$string['cour1'] = 'Enter The Course';
$string['d1'] = 'Course Discription';
$string['dis1'] = 'Enter Course Discription';
$string['course2'] = 'Second Course Name';
$string['cour2'] = 'Enter The Course';
$string['d2'] = 'Course Discription';
$string['dis2'] = 'Enter Course Discription';
$string['course3'] = 'Third Course Name';
$string['cour3'] = 'Enter The Course';
$string['d3'] = 'Course Discription';
$string['dis3'] = 'Enter Course Discription';
$string['course4'] = 'Fourth Course Name';
$string['cour4'] = 'Enter The Course';
$string['d4'] = 'Course Discription';
$string['dis4'] = 'Enter Course Discription';

$string['menusetting'] = 'Menu Settings';


$string['tab1'] = 'Enter The Website Name';
$string['t1'] = ' Second Website Name';

$string['tab2'] = 'Enter The Tab Name';
$string['t2'] = ' First Tab Name';

$string['tab3'] = 'Enter The Tab Name';
$string['t3'] = ' Second Tab Name';

$string['tab4'] = 'Enter The Tab Name';
$string['t4'] = ' Third Tab Name';

$string['tab5'] = 'Enter The Tab Name';
$string['t5'] = ' Fourth Tab Name';

$string['tab6'] = 'Enter The Tab Name';
$string['t6'] = ' Fifth Tab Name';

$string['tab7'] = 'Enter The Tab Name';
$string['t7'] = ' Sixth Tab Name';

$string['tab8'] = 'Enter The Tab Name';
$string['t8'] = ' Seventh Tab Name';

$string['tab9'] = 'Enter The Tab Name';
$string['t9'] = ' Eight Tab Name';

$string['tab10'] = 'Enter The Tab Name';
$string['t10'] = ' Ninth Tab Name';
