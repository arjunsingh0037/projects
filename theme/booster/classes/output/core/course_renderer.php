...
namespace theme_booster\output\core;
...
/**
 * Renderers to align boosters course elements to what is expect
 *
 * @package    theme_booster
...
class course_renderer extends \core_course_renderer {
    ...
    protected function coursecat_coursebox_content(coursecat_helper $chelper, $course) {
        ...
        $content .= html_writer::link(new moodle_url('/course/view.php', array('id' => $course->id)),
                            get_string('access', 'theme_booster'), array('class' => 'card-link btn btn-default'));
    ...
    protected function get_course_summary_image($course) {
        ...
        if (empty($contentimage)) {
            $url = $CFG->wwwroot . "/theme/booster/pix/default_course.jpg";
