...
class core_renderer extends \theme_boost\output\core_renderer {
    ...
    function get_heading_config()
                {
                    $theme = theme_config::load('fordson');
                    $setting = $theme->settings->heading;
                    return $setting != '' ? $setting : '';
                } 
    

     public function get_logo_config() {
        global $OUTPUT,$PAGE;
        $logo = $PAGE->theme->setting_file_url('logo', 'logo', true);
        return $logo;
    }

    public function get_logo2_config() {
        global $OUTPUT,$PAGE;
        $logo2 = $PAGE->theme->setting_file_url('logo2', 'logo2', true);
        return $logo2;
    }

    public function get_logo3_config() {
        global $OUTPUT,$PAGE;
        $logo3 = $PAGE->theme->setting_file_url('logo3', 'logo3', true);
        return $logo3;
    }
    
    public function get_logo4_config() {
        global $OUTPUT,$PAGE;
        $logo4 = $PAGE->theme->setting_file_url('logo4', 'logo4', true);
        return $logo4;
    }
    public function get_logo5_config() {
        global $OUTPUT,$PAGE;
        $logo5 = $PAGE->theme->setting_file_url('logo5', 'logo5', true);
        return $logo5;
    }
    public function get_logo6_config() {
        global $OUTPUT,$PAGE;
        $logo6 = $PAGE->theme->setting_file_url('logo6', 'logo6', true);
        return $logo6;
    }
    public function get_logo7_config() {
        global $OUTPUT,$PAGE;
        $logo7 = $PAGE->theme->setting_file_url('logo7', 'logo7', true);
        return $logo7;
    }

     

        public function get_all_uploaded_logos()
        {
            global $PAGE;
            $content = '';
            if($PAGE->theme->settings->globalsetting != 1)
            {  

                $hding = $this->get_heading_config();
                $content .='<center><h3 class="hd1">'.$hding.'</h3></center>';
                

                $logo_url = $this->get_logo_config();
                if($logo_url)
                {
                    if($PAGE->theme->settings->showlogo == 1)
                    {
                ...
                $logo_url2 = $this->get_logo2_config();
                if($logo_url2)
                {
                    if($PAGE->theme->settings->showlogo2 == 1)
                    {
                        $content .= '<div class="col1">
                                        <figure class="img1">
                                            <img src="'.$logo_url2.'">
                 ...
                 $logo_url3 = $this->get_logo3_config();
                 if($logo_url3)
                {
                    if($PAGE->theme->settings->showlogo3 == 1)
                    {
                        $content .= '<div class="col1">
                                        <figure class="img1">
                                            <img src="'.$logo_url3.'">
                ...
                $logo_url4 = $this->get_logo4_config();
                 if($logo_url4)
                {
                   if($PAGE->theme->settings->showlogo4 == 1)
                    { 
                        $content .= '<div class="col1">
                                        <figure class="img1">
                                            <img src="'.$logo_url4.'">
                 ...
                 $logo_url5 = $this->get_logo5_config();
                 if($logo_url5)
                {
                    if($PAGE->theme->settings->showlogo5 == 1)
                    { 
                        $content .= '<div class="col1">
                                        <figure class="img1">
                                            <img src="'.$logo_url5.'">
                 ...
                 $logo_url6 = $this->get_logo6_config();
                 if($logo_url6)
                {
                    if($PAGE->theme->settings->showlogo6 == 1)
                    { 
                        $content .= '<div class="col1">
                                        <figure class="img1">
                                            <img src="'.$logo_url6.'">
                ...
                $logo_url7 = $this->get_logo7_config();
                 if($logo_url7)
                {
                    if($PAGE->theme->settings->showlogo7 == 1)
                    { 
                        $content .= '<div class="col1">
                                        <figure class="img1">
                                            <img src="'.$logo_url7.'">
