...
/*Upload Image......sangita */
$string['imageupload'] = 'Upload Logos';
$string['heading'] = 'Heading';
$string['hdes'] = 'Please put the heading before the banner';

$string['logo'] = 'Upload Your Logo';
...
$string['logo2'] = 'Upload Your Logo';
$string['logodesc2'] = 'Upload your custom logo here if you want to add it to the logo list. Image works best if image    size is 100px * 100px.';

$string['logo3'] = 'Upload Your Logo';
$string['logodesc3'] ='Upload your custom logo here if you want to add it to the logo list. Image works best if image size is 100px * 100px.';

$string['logo4'] = 'Upload Your Logo';
$string['logodesc4'] = 'Upload your custom logo here if you want to add it to the logo list. Image works best if image size is 100px * 100px.';

$string['logo5'] = 'Upload Your Logo';
$string['logodesc5'] = 'Upload your custom logo here if you want to add it to the logo list. Image works best if image size is 100px * 100px.';

$string['logo6'] = 'Upload Your Logo';
$string['logodesc6'] = 'Upload your custom logo here if you want to add it to the logo list. Image works best if image size is 100px * 100px.';

$string['logo7'] = 'Upload Your Logo';
$string['logodesc7'] = 'Upload your custom logo here if you want to add it to the logo list. Image works best if image size is 100px * 100px.';


/*check box setting......sangita*/

$string['globalsetting'] = 'Hide All images';
$string['globalsetting_desc'] = 'Allow user to remove all images using the global settings.';


$string['showlogo'] = 'Show Logo1 Images';
$string['showlogo_desc'] = 'Allow user to customize the logo1 image by uploading an image file into upload logos settings.';

$string['showlogo2'] = 'Show Logo2 Images';
$string['showlogo2_desc'] = 'Allow user to customize the logo2 image by uploading an image file into upload logos settings.';

$string['showlogo3'] = 'Show Logo3 Images';
$string['showlogo3_desc'] = 'Allow user to customize the logo3 image by uploading an image file into upload logos settings.';

$string['showlogo4'] = 'Show Logo4 Images';
$string['showlogo4_desc'] = 'Allow user to customize the logo4 image by uploading an image file into upload logos settings.';

$string['showlogo5'] = 'Show Logo5 Images';
$string['showlogo5_desc'] = 'Allow user to customize the logo5 image by uploading an image file into upload logos settings.';

$string['showlogo6'] = 'Show Logo6 Images';
$string['showlogo6_desc'] = 'Allow user to customize the logo6 image by uploading an image file into upload logos settings.';
$string['showlogo7'] = 'Show Logo7 Images';
$string['showlogo7_desc'] = 'Allow user to customize the logo7 image by uploading an image file into upload logos settings.';