...
if ($formaction != null && $userenrolments != null) {
    ...
    switch ($formaction) {
        ...
        case 'confirm':
            ...
            $manageurl = new moodle_url('/course/index.php', array());
            // echo '<a href="http://localhost/sangita/course/view.php?id=9"></a>';
            // echo '<script>window.location.href = "http://localhost/sangita/course/view.php?id=9";</script>';
            break;
        case 'wait':
