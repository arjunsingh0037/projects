...
//print_object($reply)||die();
// print_object($forum)||die();
// print_object($edit)||die();
// print_object($delete)||die();
// print_object($prune)||die();
// print_object($name)||die();
// print_object($confirm)||die();
// print_object($groupid)||die();
//exit();
