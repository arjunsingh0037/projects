...
$string['everyonecannowchoosebyadmin'] = 'Everyone can now choose to be subscribed by Admin';
...
$string['postaddedsuccessbyuser'] = 'Your post was successfully send to Admin approval.Please wait some time.';
$string['replymessagebyuser'] = 'Your Reply was successfully send to Admin approval.Please wait some time.';
$string['postaddedbyuserdisplay'] = 'This post is not approve by Admin.Please wait some time.';
...
$string['postinsertification'] = 'postinsertificationpostinsertificationpostinsertification';
...
$string['qandanotify'] = 'Optional subscription';
$string['subscriptionforced'] = 'Forced subscription';
$string['subscriptionauto'] = 'Auto subscription';
$string['subscriptiondisabled'] = 'Subscription disabled';
$string['subscriptionbyadmin'] = 'Subscription By Admin';
...
$string['approvebuttontitle'] = 'Approve by {$a}';

$string['subscriptionoptional'] = 'Optional hello subscription';
