 ...
 */
    ...
    $cm = get_coursemodule_from_instance('hsuforum', $forum->id, $course->id, false, MUST_EXIST);
     ...
     //print_object($discussion)||die();//get data from mdl_hsuforum_disscussion
    // print_object($course)||die();
     //print_object($forum)||die();//mdl_hsuforum table
     //print_object($cm);
    //exit();
