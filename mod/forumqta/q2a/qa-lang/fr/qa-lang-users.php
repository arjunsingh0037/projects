...
#     Traduction fr par Olivier SEREE (contrib[at]seree.fr) http://*.solu.fr
	...
	return array(
		...
		'category_level_label' => 'Mise à jour vers:',
		...
		'confirm_required' => 'Pour compléter votre inscription, cliquer sur le lien de confirmation qui a été envoyé par courriel, ou ^1demander en un autre^2.',
		...
		'email_exists' => 'Email appartient déjà à un compte',
		'email_handle_label' => 'Email ou Pseudo:',
		'email_invalid' => 'Le courriel est invalide - Veuillez vérifier soigneusement',
		'email_label' => 'Email:',
		...
		'handle_exists' => 'Le nom d\'utilisateur est pris -  essayer en un autre',
		'handle_has_bad' => 'Le nom d\'utilisateur ne doit pas contenir: ^',
		'handle_label' => 'Pseudo:',
		'hide_all_user_button' => 'Cachez tous les messages de cet utilisateur',
		...
		'only_shown_admins' => '(seulement montré aux admins)',
		'only_shown_editors' => '(seulement montré aux éditeurs et au-dessus)',
		'only_shown_experts' => '(seulement montré aux experts et au-dessus)',
		'only_shown_moderators' => '(seulement montré que les modérateurs et administrateurs)',
		'password_changed' => 'Mot de passe modifié',
		'password_label' => 'Mot de passe:',
		'password_min' => 'Le mot de passe doit comporter au moins  ^ caractères',
		'password_mismatch' => 'Nouveaux mots de passe ne correspondent pas',
		'password_none' => 'Aucun. Pour se connecter directement , définissez un mot de passe ci-dessous.',
		'password_sent' => 'Votre nouveau mot de passe vous a été envoyé par courriel',
		'password_to_set' => 'S\'il vous plaît mettre sur votre page de compte',
		...
		'wall_posts_explanation' => 'Autoriser les utilisateurs à publier sur votre mur (vous serez également envoyé par courriel)',
		'register_button' => 'Inscription',
		'register_limit' => 'Trop inscriptions - essayer à nouveau dans une heure',
		'register_suspended' => 'L\'inscription de nouveaux utilisateurs a été temporairement suspendu . S\'il vous plaît essayez de nouveau bientôt.',
		...
		'unsubscribe_complete' => 'Vous vous êtes désabonné de publipostages envoyés par ^0. Vous pouvez vous réinscrire à tout moment via votre ^1compte^2.', 
		'unsubscribe_title' => 'Désabonner',
		'unsubscribe_wrong_log_in' => 'Code incorrect - ^1Connectez vous^2 pour se désabonner',
