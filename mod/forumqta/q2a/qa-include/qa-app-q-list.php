	...
	$request='questions';
		...
		$navigation=array(
			'recent' => array(
				...
				//'url' => 'http://localhost/q2a/index.php?k_1='.$category_tags.'&qa=questions&qa_1='.$category_tags,
			),
			
			'hot' => array(
				'label' => qa_lang('main/nav_hot'),
                'url' => qa_path_html($request, array('sort' => 'hot')),
				//'url' => 'http://localhost/q2a/index.php?k_1='.$category_tags.'&qa=questions&qa_1='.$category_tags.'&sort=hot',
			),
			
			'votes' => array(
				'label' => qa_lang('main/nav_most_votes'),
                'url' => qa_path_html($request, array('sort' => 'votes')),
				//'url' => 'http://localhost/q2a/index.php?k_1='.$category_tags.'&qa=questions&qa_1='.$category_tags.'&sort=votes',
			),

			'answers' => array(
				'label' => qa_lang('main/nav_most_answers'),
                'url' => qa_path_html($request, array('sort' => 'answers')),
				//'url' => 'http://localhost/q2a/index.php?k_1='.$category_tags.'&qa=questions&qa_1='.$category_tags.'&sort=answers',
			),

			'views' => array(
				'label' => qa_lang('main/nav_most_views'),
                'url' => qa_path_html($request, array('sort' => 'views')),
				//'url' => 'http://localhost/q2a/index.php?k_1='.$category_tags.'&qa=questions&qa_1='.$category_tags.'&sort=views',
			),
		);
	...
	$category_tags = substr ($querystring , $position1+4,$longueur);
		...
		$navigation=array(
			'by-answers' => array(
                ...
                'url' => qa_path_html($request),
				//'url' => 'http://localhost/q2a/index.php?k_1='.$category_tags.'&qa=unanswered&qa_1='.$category_tags,
			),
			
			'by-selected' => array(
				'label' => qa_lang('main/nav_no_selected_answer'),
                'url' => qa_path_html($request, array('by' => 'selected')),
				//'url' => 'http://localhost/q2a/index.php?k_1='.$category_tags.'&qa=unanswered&qa_1='.$category_tags.'&by=selected',
			),
			
			'by-upvotes' => array(
				'label' => qa_lang('main/nav_no_upvoted_answer'),
                'url' => qa_path_html($request, array('by' => 'upvotes')),
				//'url' => 'http://localhost/q2a/index.php?k_1='.$category_tags.'&qa=unanswered&qa_1='.$category_tags.'&by=upvotes',
			),
		);
