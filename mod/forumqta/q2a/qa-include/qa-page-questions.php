...
//	Get list of questions, plus category information
	...
	if ($countslugs) {
		...
		$nonetitle=qa_lang_html('main/no_questions');
	...
	switch ($sort) {
		case 'hot':
			$sometitle=$countslugs ? qa_lang_html('main/hot_qs') : qa_lang_html('main/hot_qs_title');
			$feedpathprefix=qa_opt('feed_for_hot') ? 'hot' : null;
			break;
			
		case 'votes':
			$sometitle=$countslugs ? qa_lang_html('main/voted_qs') : qa_lang_html('main/voted_qs_title');
			break;
			
		case 'answers':
			$sometitle=$countslugs ? qa_lang_html('main/answered_qs') : qa_lang_html('main/answered_qs_title');
			break;
		
		case 'views':
			$sometitle=$countslugs ? qa_lang_html('main/viewed_qs') : qa_lang_html('main/viewed_qs_title');
			break;
		
		default:
			$linkparams=array();
			$sometitle=$countslugs ? qa_lang_html('main/recent_qs') : qa_lang_html('main/recent_qs_title');
