			...
			switch ($optionname) { // special treatment for certain options
				...
				case 'site_theme_mobile':
					...
					if (!isset($themeoptions[$value]))
						$value='Mdcl'; // check here because we also need $value for qa_admin_addon_metadata()
				...
				case 'feed_for_tag_qs':
					...
					$populartags=qa_db_select_with_pending(qa_db_popular_tags_selectspec(0, 1,$category_tags));
