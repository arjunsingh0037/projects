...
{
    //the function has been in comment because the call to 'qa_db_search_posts_selectspec'
    //does not receive url parameters(category_id) at all for unknown reason, maybe because of AJAX
