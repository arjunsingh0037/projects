...
{
    var k_1 = getURLParameter('k_1');
    var groupid = getURLParameter('groupid');
    var cmid = getURLParameter('cmid');
    var qa = getURLParameter('qa');

    jQuery.extend(params, {qa:'ajax', qa_operation:operation, qa_root:qa_root, qa_request:qa_request, qa_k_1: k_1, qa_groupid:groupid, qa_cmid:cmid, qa_qa:qa});
